...
import com.example.yc.mvpdemo.empty.presenter.Fragment1Presenter;
import com.example.yc.mvpdemo.empty.R;
import com.example.yc.mvpdemo.empty.bean.TestBean;
import com.example.yc.mvpdemo.empty.contract.Fragment1Contract;
...
//        mRefreshLayout.shouldHandleRecyclerViewLoadingMore(mRvNews);
    ...
    @Override
    public void successInfo(TestBean str) {
