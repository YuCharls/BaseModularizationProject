package mvpdemo.yc.example.com.model_common.http;


import mvpdemo.yc.example.com.model_common.base.BaseApplication;
import mvpdemo.yc.example.com.model_common.url.UrlHelper;
import mvpdemo.yc.example.com.model_common.utils.LogUtil;
import mvpdemo.yc.example.com.model_common.utils.NetworkUtil;
import mvpdemo.yc.example.com.model_common.utils.SPUtil;
    ...
    private static Interceptor addCacheInterceptor() {
        Interceptor cacheInterceptor = new Interceptor() {
            ...
            public Response intercept(Chain chain) throws IOException {
                ...
                if (!NetworkUtil.isNetworkAvailable(BaseApplication.getIns())) {
        ...
        if (retrofit == null) {
            synchronized (Http.class) {
                if (retrofit == null) {
                    ...
                    //设置 请求的缓存的大小跟位置
                    File cacheFile = new File(BaseApplication.getIns().getCacheDir(), "cache");
