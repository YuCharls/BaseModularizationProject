package com.example.yc.mvpdemo.main.fragment;
...
import com.example.yc.mvpdemo.main.contract.Fragment1Contract;

import mvpdemo.yc.example.com.model_common.mvp.IView;

import com.example.yc.mvpdemo.main.presenter.Fragment1Presenter;
...
//            mPresenter.clickButton(phone, password);
            ...
            ARouter.getInstance().build("/model_z_empty/test").navigation();
